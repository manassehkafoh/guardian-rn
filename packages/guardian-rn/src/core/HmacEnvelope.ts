...
/**
 * Constant-time string comparison that mitigates timing leaks and CPU exhaustion (DoS).
 * Iterate exactly over the trusted string length to avoid an attacker forcing a massive loop.
 */
